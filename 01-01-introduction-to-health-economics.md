# Chapter 1.1 — Introduction to Health Economics
...
Every health system on earth spends less than it could usefully absorb. A hospital could always hire another nurse, run another clinic, buy another scanner; a ministry could always fund another vaccine, another drug, another prevention programme. Because the money, staff, and time are finite and the demand is effectively unlimited, choices are unavoidable — and every choice funds some patients while, silently, not funding others. [Health economics](https://en.wikipedia.org/wiki/Health_economics) exists to make those silent choices visible, comparable, and defensible.

The stakes are unusually high. Health spending is among the largest lines in most national budgets, funded from taxation, compulsory social insurance, private premiums, or families' own pockets. The decisions it governs are matters of life, disability, and dignity, and they fall unequally across rich and poor. When a decision is made badly — funding a marginal therapy while a cost-effective one goes without — the loss is not abstract. It is measured in avoidable deaths and suffering among the people who were crowded out, even though no one ever sees their names.

For a director, health economics is not an academic ornament but the grammar of accountability. It gives you a shared language for arguing about value with clinicians, finance officers, regulators, and the public, and a set of methods for testing claims that would otherwise be settled by whoever speaks most confidently. This chapter introduces that language and the map of the whole field. It signposts; the chapters that follow do the deep work.

## Core concepts

**Scarcity** is the starting axiom. [Scarcity](https://en.wikipedia.org/wiki/Scarcity) means that resources — money, clinicians, beds, operating-theatre hours, a patient's own time — are insufficient to satisfy all the wants that could lay claim to them. Scarcity is not the same as poverty; even the richest health systems are scarce, because the frontier of what medicine *could* do always outruns what any budget *can* do. Health economics takes scarcity as permanent and asks how to live with it well.

**Opportunity cost** is the concept that follows directly. The [opportunity cost](https://en.wikipedia.org/wiki/Opportunity_cost) of a decision is the value of the best alternative it displaces. Spending a fixed budget on a new cancer drug has a cost measured not only in currency but in the health that the same money would have produced elsewhere — the hip replacements, mental-health sessions, or antenatal visits forgone. In a fixed-budget health system, opportunity cost is the true price of everything, and much of health economics is machinery for estimating it. Rationing at the system level (see Chapter 3.3 — Rationing) is opportunity cost made operational.

**Efficiency** is doing the most good with given resources — but the word hides two distinct ideas. [Economic efficiency](https://en.wikipedia.org/wiki/Economic_efficiency) splits into *technical* efficiency (producing a given output with the fewest inputs, or the most output from given inputs) and *allocative* efficiency (producing the mix of outputs that yields the greatest value to society). A hospital can be technically efficient — running lean, wasting nothing — while being allocatively wrong, delivering the wrong services superbly. Both matter, and they are not interchangeable.

**Marginal analysis** is how economists actually make these judgements. [Marginalism](https://en.wikipedia.org/wiki/Marginalism) asks not "is this service worthwhile?" but "is the *next* unit of it worth more than the same resources spent elsewhere?" The right question is rarely all-or-nothing. It is whether to screen at age 50 or 55, whether the tenth follow-up appointment adds as much as the first, whether one more percentage point of vaccination coverage justifies its rising cost. Value is found at the margin, and averages routinely mislead. When budgets shift, the right instrument is often *programme budgeting and marginal analysis* — comparing what an extra pound buys across competing uses.

**Why health care is economically distinctive.** Health economics is a separate field, rather than a corner of ordinary microeconomics, because health care violates the assumptions of a textbook market in systematic ways. Its intellectual charter is [Kenneth Arrow](https://en.wikipedia.org/wiki/Kenneth_Arrow)'s 1963 paper "Uncertainty and the Welfare Economics of Medical Care", which showed that pervasive uncertainty and unequal information make medical markets behave unlike markets for ordinary goods. Four features recur: demand is uncertain and often urgent; patients know far less than their clinicians, creating [information asymmetry](https://en.wikipedia.org/wiki/Information_asymmetry) and an agency relationship in which the seller advises the buyer; third parties usually pay, blunting price signals; and health has consequences for others — vaccination protects the unvaccinated, antimicrobial resistance harms future patients — so private choices carry public effects. These distinctive features are the subject of Chapter 1.2 — Demand for Health and Healthcare and Chapter 1.3 — Market Failure; here they explain only *why the field exists*.

**The Williams "plumbing diagram."** The most useful single map of health economics is the schematic drawn by the British economist [Alan Williams](https://en.wikipedia.org/wiki/Alan_Williams_(economist)) in the late 1980s, universally known as the plumbing diagram because it shows how the field's topics feed into one another like connected pipes. It divides the discipline into eight interconnected boxes:
...
- **B — What is health, and what is it worth?** Defining and valuing health outcomes, including measures such as the [quality-adjusted life year](https://en.wikipedia.org/wiki/Quality-adjusted_life_year) (QALY) and the disability-adjusted life year (DALY).
...
|---|---|---|---|---|
| **Framing decisions** | Bids judged in isolation against "doing nothing"; need drives spending | Some comparison between options, but no fixed budget constraint | Every proposal names its opportunity cost against a defined budget | Marginal analysis is routine; investment and disinvestment are paired |
| **Use of methods** | Decisions settled by seniority and confidence | Ad hoc cost analysis for large bids only | Cost-effectiveness and outcome measures used consistently for major decisions | Methods matched to the plumbing-diagram box; specialists engaged appropriately |
| **Efficiency thinking** | Efficiency equated with cost-cutting | Technical efficiency pursued; allocation unquestioned | Technical and allocative efficiency distinguished explicitly | Resources actively reallocated from low- to high-value activity |
| **Equity** | Distribution unexamined | Equity raised informally, after the efficiency case | Distributive aims stated alongside efficiency aims | Equity–efficiency trade-offs surfaced, quantified where possible, and defended in public |
| **Transparency** | Assumptions hidden; results asserted | Some analysis documented, not challenged | Assumptions and comparators exposed for scrutiny | Disagreement structured around explicit, contestable assumptions |
