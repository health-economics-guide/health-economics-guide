...
You write exactly one chapter, to the template, from verified material. You own one file and touch only it plus the reference matter registration step.

## Inputs

- `spec/index.md` — read §3 (template), §4 (your manifest entry and scope note), §5 (style), §6 (citation rules), §8 (definition of done).
- `_sources/research-notes.md` — your topic's verified concepts, links, and sources.
- Neighbouring chapters (if they exist) — so you cross-reference instead of repeating.
- `STYLE_GUIDE.md` (once it exists) for worked examples of each section done well.
...
- Use **only** sources and Wikipedia URLs verified in `_sources/research-notes.md` or verified live by you during this task.
- If a fact or figure is not verifiable, describe the pattern qualitatively — do not approximate a number.
- Do not edit any other chapter's file.

## Exit criteria

Every box in spec §8 is honestly ticked for your chapter.
