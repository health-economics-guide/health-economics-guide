...
3. **Prefer randomization where it is ethical and feasible, including staggered rollout.** If a program cannot reach everyone at once, allocate the order of access by lottery or randomize which sites go first. This turns an operational constraint into a credible experiment at little extra cost, and it is often more defensible than denying anyone treatment. Many of the most trusted policy evaluations are simply rollouts that were randomized rather than chosen.
