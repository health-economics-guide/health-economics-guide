...
| Opportunity cost | Only benefits of new spend considered | Costs noted but displacement ignored | Displacement analysis required for major decisions | Displacement quantified and its bearers tracked across the budget | Marginal, system-wide opportunity cost routinely optimized across programs |
...
- [ ] Technical estimates are kept separate from, and stated alongside, the social value judgments applied to them.
