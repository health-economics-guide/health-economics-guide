...
|---|---|---|---|---|
| Acknowledging rationing | Denied; "we fund what's needed" | Acknowledged privately, not in public | Openly named as a system function | Framed publicly as a fairness discipline citizens engage with |
| Explicit vs implicit | Allocation hidden in queues and discretion | Some published criteria, inconsistently applied | Explicit criteria for most major decisions | Explicit rules with audited consistency and low unwarranted variation |
| Procedural fairness | No route to reasons or appeal | Reasons given ad hoc | Accountability for reasonableness in place (publicity, relevance, revisability, enforcement) | Public deliberation shapes the rules; process trusted by losers |
| Opportunity cost | Only benefits of new spend considered | Costs noted but displacement ignored | Displacement analysis required for major decisions | Marginal, system-wide opportunity cost routinely quantified |
| Disinvestment | None; budget only ever grows commitments | Occasional crisis-driven cuts | Standing low-value-care review releasing resources | Continuous, evidence-based reallocation paired with investment |
